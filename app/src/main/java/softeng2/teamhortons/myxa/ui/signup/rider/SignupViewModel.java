...
class SignupViewModel extends ViewModel {
    ...
    private RiderUserRepository userRepository;

    SignupViewModel(AuthRepository authRepository, RiderUserRepository userRepository) {
    ...
    void signUp(final String firstName, final String lastName, final boolean isMale, final int age,
                final String plate, final String license, final String email, String password) {
    ...
    void signUpDataChanged(String fName, String lName, String gender, String age, String plate, String license, String email,
        ...
        signupFormState.setValue(new SignupFormState(
                ...
                (plate.isEmpty() ? R.string.empty_field : null),
                (license.isEmpty() ? R.string.empty_field : null),
        ...
        if(!isFieldsEmpty(fName, lName, gender, age, plate, license) && isEmailValid(email) &&
    ...
    private boolean isFieldsEmpty(String firstName, String lastName, String gender, String age, String plate, String license) {
