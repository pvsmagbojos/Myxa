...
import softeng2.teamhortons.myxa.RiderActivity;
...
public class RiderLoginActivity extends AppCompatActivity {
    private RiderLoginViewModel loginViewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loginViewModel = new ViewModelProvider(this, new RiderLoginViewModelFactory())
                .get(RiderLoginViewModel.class);
        ...
        loginViewModel.getLoginResult().observe(this, loginResult -> {
            ...
            if (loginResult.getSuccess() != null) {
                setResult(RESULT_OK, new Intent(RiderLoginActivity.this, RiderActivity.class));
                finish();
            }
        });
